...
const initialEvents = [
  ...
  },
  {
    ...
    description: "A dedicated quiz module offering bite-sized practice questions on aptitude, logical reasoning, coding and verbal skills, designed to be engaging, time-efficient, and progressively challenging for daily practice.",
    date: "29",
    month: "October",
    time: "7:00am 8:00am",
    location: "Nagpur, India",
